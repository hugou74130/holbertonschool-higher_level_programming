...
class Square:  # Définition de la classe 'Square'
    ...
    def __init__(self, size=0):  # Constructeur: paramètre `size` par défaut 0
        ...
        self.__size = size  # Affecte une valeur à 'self.__size'

    def area(self):  # Définit la fonction 'area'
        """Calculate and return the area of the square."""  # Docstring de la méthode
        # Calcule l'aire en multipliant la taille par elle-même.
        return self.__size * self.__size  # Retourne le résultat
